...
urlpatterns = [
    ...
    path('load_entries/<int:car_id>/<str:category>/<str:search_phrase>', views.async_load_entries_list, name='load_entries_list_url'),
    path('load_entries/<int:car_id>/', views.async_load_entries_list, name='load_entries_list_url'),
