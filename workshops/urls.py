...
urlpatterns = [
    ...
    path('edit_workshop/', views.async_edit_workshop, name='edit_workshop_details_url'),
    ...
    path('load_workshops/<str:category>/<str:filter>', views.async_load_workshops_list, name='load_workshops_list_url'),
